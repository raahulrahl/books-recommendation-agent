...
def main():
    ...
    parser.add_argument(
        "--model",
        type=str,
        default=os.getenv("MODEL_NAME", "openai/gpt-4.1-mini"),
        help="Model ID to use (default: openai/gpt-4.1-mini, env: MODEL_NAME), if you want you can use any free model: https://openrouter.ai/models?q=free",
    )
